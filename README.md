...
3. Navigation & Routing
    - [Navigator 1.0 (Imperative)](training/3_flutter_navigator.md)
    ...
    - [Navigator 2.0 (Declarative)](training/3_1_flutter_navigation_2.md)
        - [Overview](training/3_1_flutter_navigation_2.md#overview)
        - [Key Concepts](training/3_1_flutter_navigation_2.md#key-concepts)
        - [RouteInformationParser](training/3_1_flutter_navigation_2.md#route-information-parser)
        - [RouterDelegate](training/3_1_flutter_navigation_2.md#router-delegate)
        - [Putting It All Together](training/3_1_flutter_navigation_2.md#putting-it-all-together)
        - [Bonus: go_router](training/3_1_flutter_navigation_2.md#bonus-go-router)
